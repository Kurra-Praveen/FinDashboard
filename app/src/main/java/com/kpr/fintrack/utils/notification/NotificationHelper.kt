...
import com.kpr.fintrack.services.notification.DailySpendingNotificationService
...
class NotificationHelper @Inject constructor(
    ...
    fun getNotificationSettings(): NotificationSettings {
        return NotificationSettings(
            dailyNotificationsEnabled = isDailySpendingNotificationEnabled(),
            notificationTime = getNotificationTimePreference(),
            notificationFrequency = getNotificationFrequencyPreference(),
            insightsEnabled = getNotificationInsightsPreference(),
            comparisonEnabled = getNotificationComparisonPreference(),
            budgetAlertsEnabled = getNotificationBudgetAlertsPreference()
        )
    }

    fun updateNotificationSettings(settings: NotificationSettings) {
        setDailySpendingNotificationEnabled(settings.dailyNotificationsEnabled)
        setNotificationTimePreference(settings.notificationTime)
        setNotificationFrequencyPreference(settings.notificationFrequency)
        setNotificationInsightsPreference(settings.insightsEnabled)
        setNotificationComparisonPreference(settings.comparisonEnabled)
        setNotificationBudgetAlertsPreference(settings.budgetAlertsEnabled)
    }
